...
export const ENTRY_ID: string | undefined = import.meta.env.VITE_ENTRY_ID;
export const ACCESS_TOKEN: string | undefined = import.meta.env.VITE_ACCESS_TOKEN;
export const KERNEL_ID: string | undefined = import.meta.env.VITE_KERNEL_ID;

// Define contract config interface
